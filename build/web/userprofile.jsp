        ...
        <header>
            <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand" href="#">
                    <img src="/docs/4.6/assets/brand/bootstrap-solid.svg" width="30" height="30" class="d-inline-block align-top"
                         alt="">
                    NameofWebsite
                </a>
            ...
            <form action="UpdateProfile" method="post">
                <div class="container rounded bg-white mt-5 mb-5">
                    <div class="row">
                        <div class="col-md-3 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                <img class="rounded-circle mt-5"
                                                                                                         width="150px"
                                                                                                         src="assest/img/userprofile.png"><br><span
                                                                                                         class="font-weight-bold"><%= fname%> <%= lname%></span><span class="text-black-50"><%= email%></span><span>
                                </span>
                                <form action="deleteprofile" method="post">
                                    <button class="mt-3 btn btn-danger profile-button" type="submit" name="submitbutton" value="delete">Delete Profile</button>
                                </form>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="p-3 py-5">
                                <div class="d-flex justify-content-between align-items-center experience"><span>Past Performance: </span></div><br>
                                <div class="col-md-12"><label class="labels">List of Previously Earned Certificates:</label></div> <br>
                            </div>
                        </div>
                    </div>
                </div>
